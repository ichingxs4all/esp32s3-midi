...
// Instantiate a 5-pin DIN MIDI interface (on the TX and RX pins of Serial0)
...
// Instantiate the pipe to connect the two interfaces
BidirectionalMIDI_Pipe pipes_usb_ser;
// Instantiate the pipe to connect the two interfaces
BidirectionalMIDI_Pipe pipes_usb_ble;
...
void setup() {
  ...
  midi_ser | pipes_usb_ser | midi_usb;
  midi_ble | pipes_usb_ble | midi_usb;
